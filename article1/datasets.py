...
def datasets_for(name: str, root: Path):
    ...
    if name == "cifar":
        ...
        return (
            datasets.CIFAR10(root, train=True, download=True, transform=train_t),
            datasets.CIFAR10(root, train=True, download=True, transform=eval_t),
            datasets.CIFAR10(root, train=False, download=True, transform=eval_t),
        )
    if name in {"mnist", "fmnist"}:
        ...
        return (
            cls(root, train=True, download=True, transform=t),
            cls(root, train=True, download=True, transform=t),
            cls(root, train=False, download=True, transform=t),
        )
